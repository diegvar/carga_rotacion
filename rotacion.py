...
TOKEN = os.getenv("TOKEN_CR")#'xMAOXmuzF8MeHi+qZLbgkd1Dg8WuzzHXsXbDG3K8D08='
...
# Cargar a BigQuery
    ...
    print(f"Data procesada exitosamente. {len(data)} registros cargados a BigQuery.")
    
    return jsonify({
        "success": True,
        "message": "Data procesada procesado exitosamente",
